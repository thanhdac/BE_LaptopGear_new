...
class DanhMucCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug_danh_muc'   => 'required|string|unique:danh_mucs,slug_danh_muc|min:5|max:45',
    ...
    public function messages()
    {
        return [
            ...
            'slug_danh_muc.max' => 'Slug danh mục không được vượt quá 45 ký tự.',
            'slug_danh_muc.min' => 'Slug danh mục phải có ít nhất 5 ký tự.',
